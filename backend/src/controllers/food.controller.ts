...
export const create = asyncHandler(
  async (
    ...
    const parsed =
      createFoodSchema.safeParse(req.body);
...
export const update = asyncHandler(
  ...
  throw new ApiError(
    ...
    const parsed =
      updateFoodSchema.safeParse(req.body);
...
export const updateStatus = asyncHandler(
  ...
  throw new ApiError(
    ...
    const parsed =
      updateFoodStatusSchema.safeParse(
        req.body
      );
