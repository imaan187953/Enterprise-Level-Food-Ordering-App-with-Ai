...
export const changeAvatar = asyncHandler(
  async (
    ...
    const result =
      changeAvatarSchema.safeParse(req.body);
...
export const changePhone = asyncHandler(
  async (
    ...
    const result =
      changePhoneSchema.safeParse(req.body);
    ...
    const user = await changeUserPhone(
      req.user.userId,
      result.data
    );
 ...
 */
export const updateOwnStatus = asyncHandler(
  async (
    req: AuthenticatedRequest,
    res: Response
  ) => {
    ...
    const user = await updateOwnAccountStatus(
      req.user.userId,
