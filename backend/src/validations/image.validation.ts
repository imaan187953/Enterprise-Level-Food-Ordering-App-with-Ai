...
export type SearchImageInput = z.infer<
  typeof searchImageSchema
>;

export type CreateImageValidationInput = z.infer<
  typeof createImageSchema
>;

export type UpdateImageUsageValidationInput = z.infer<
  typeof updateImageUsageSchema
>;