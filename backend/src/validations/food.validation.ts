...
export type CreateFoodValidationInput = z.infer<
  typeof createFoodSchema
>;

export type UpdateFoodValidationInput = z.infer<
  typeof updateFoodSchema
>;

export type UpdateFoodStatusValidationInput = z.infer<
  typeof updateFoodStatusSchema
>;